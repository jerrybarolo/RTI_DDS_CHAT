...
/**
 * A sequence of RtiChat instances.
 */
public final class RtiChatSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public RtiChatSeq(int initialMaximum) {
        super(RtiChat.class, initialMaximum);
    }


    public RtiChatSeq(Collection elements) {
        super(RtiChat.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    set(i, RtiChat.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }
        
        // copy 'new' RtiChat objects (beyond the original size of this object)
