 ...
 * RtiChat.
 */
public class RtiChatTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "RtiChat";
    ...
    private static final RtiChatTypeSupport _singleton
        = new RtiChatTypeSupport();
     ...
     */
    public static RtiChatTypeSupport get_instance() {
        return _singleton;
    }

    public static RtiChatTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return RtiChat.create();
    }
     ...
     * <code>this</code> is not a <code>RtiChat</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        RtiChat typedDst = (RtiChat) destination;
        RtiChat typedSrc = (RtiChat) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.RtiChat.MAX_NAME_LEN.VALUE))) + 1);
            
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.RtiChat.MAX_MSG_LEN.VALUE))) + 1);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        RtiChat typedSrc = (RtiChat) sample;
...
RtiChat typedSrc = (RtiChat) src;    
        ...
        dst.writeString(typedSrc.sender,((com.rti.RtiChat.MAX_NAME_LEN.VALUE)));
            
        dst.writeString(typedSrc.message,((com.rti.RtiChat.MAX_MSG_LEN.VALUE)));
...
RtiChat typedDst = (RtiChat) dst;
        
            typedDst.clear();
    try {

            typedDst.sender = src.readString(((com.rti.RtiChat.MAX_NAME_LEN.VALUE)));
            
            typedDst.message = src.readString(((com.rti.RtiChat.MAX_MSG_LEN.VALUE)));
...
RtiChat typedDst = (RtiChat) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
RtiChat typedDst = (RtiChat) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new RtiChatDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new RtiChatDataReader(native_reader, listener, mask, this);                
    ...
    protected RtiChatTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,RtiChatTypeCode.VALUE,RtiChat.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected RtiChatTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,RtiChatTypeCode.VALUE,RtiChat.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
