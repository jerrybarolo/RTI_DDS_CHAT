...
/**
 * A writer for the RtiChat user type.
 */
public class RtiChatDataWriter extends DataWriterImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public InstanceHandle_t register_instance(RtiChat instance_data) {
        return register_instance_untyped(instance_data);
    }
    
    
    public InstanceHandle_t register_instance_w_timestamp(RtiChat instance_data,
    ...
    public InstanceHandle_t register_instance_w_params(RtiChat instance_data,
    ...
    public void unregister_instance(RtiChat instance_data,
                                     InstanceHandle_t handle) {
        unregister_instance_untyped(instance_data, handle);
    }
    
    
    public void unregister_instance_w_timestamp(RtiChat instance_data,
    ...
    public void unregister_instance_w_params(RtiChat instance_data,
                                             WriteParams_t params) {
    ...
    public void write(RtiChat instance_data, InstanceHandle_t handle) {
        write_untyped(instance_data, handle);
    }
    
    
    public void write_w_timestamp(RtiChat instance_data,
            InstanceHandle_t handle, Time_t source_timestamp) {
    ...
    public void write_w_params(RtiChat instance_data,
                               WriteParams_t params) {
    ...
    public void dispose(RtiChat instance_data, InstanceHandle_t instance_handle){
        dispose_untyped(instance_data, instance_handle);
    }
    
    
    public void dispose_w_timestamp(RtiChat instance_data,
    ...
    public void dispose_w_params(RtiChat instance_data,
                                 WriteParams_t params) {
    ...
    /*package*/ RtiChatDataWriter(long native_writer, DataWriterListener listener,
